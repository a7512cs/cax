    ...
    public class CaxME
    {
        ...
        public static bool GetFcfData(NXOpen.Annotations.DraftingFcf temp, out FcfData sFcfData)
        {
            ...
            try
            {
                ...
                {
                    sFcfData.ZoneShape = draftingFeatureControlFrameBuilder1.Characteristic.ToString();
                }
                #endregion
                ...
                #region PrimaryDatumReference.MaterialCondition
                ...
                #region SecondaryDatumReference
                ...
                #region SecondaryDatumReference.MaterialCondition
                ...
                #region TertiaryDatumReference.MaterialCondition
