...
namespace OutputExcelForm.Excel
{
    public class Excel_ShopDoc
    {
        ...
        public static bool CreateShopDocExcel_XinWu(string partNo, string cusVer, string op1, DB_TEMain sDB_TEMain, IList<Com_ShopDoc> cCom_ShopDoc)
        {
            try
            {
                ...
                //設定輸出路徑
                string OutputPath = string.Format(@"{0}\{1}_{2}_OP{3}\{4}_{5}_{6}_{7}", Environment.GetFolderPath(Environment.SpecialFolder.Desktop)
                                                                                  , partNo
                                                                                  , cusVer
                                                                                  , op1
                                                                                  , partNo
